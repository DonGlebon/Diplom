...
import com.diplom.map.GEOLayer
import com.diplom.map.PointLayer
import com.diplom.map.PolygonLayer
...
class MapScreenPresenter : BasePresenter<MapScreenContract.View>(), MapScreenContract.Presenter {
    ...
    private var layout: PolygonLayer = PolygonLayer("alaska", "/storage/emulated/0/Map/")
    private var layoutP: PointLayer = PointLayer("airports1", "/storage/emulated/0/Map/")
